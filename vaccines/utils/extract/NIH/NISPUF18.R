...
flatfile <- paste0(flatfile_path,"/NISPUF18.DAT")
...
ESTIAPlevels=c(1,10,105,107,109,11,12,13,14,16,17,18,19,2,20,22,25,27,28,29,30,31,34,35,36,38,4,40,41,44,46,47,49,5,50,51,54,55,56,57,58,59,6,60,61,62,63,64,65,66,68,7,72,73,74,75,76,77,8)
ESTIAPlabels=c("CT", "NY-REST OF STATE", "GUAM", "TX-HIDALGO COUNTY", "TX-TARRANT COUNTY", "NY-CITY OF NEW YORK", "DC", "DE", "MD", "PA-REST OF STATE", "PA-PHILADELPHIA COUNTY", "VA", "WV", "MA", "AL", "FL", "GA", "KY", "MS", "NC", "SC", "TN",
...
label(NISPUF18$ESTIAP) <- "ESTIMATION AREA OF RESIDENCE"
...
NISPUF18$ESTIAP <- factor(NISPUF18$ESTIAP, levels=ESTIAPlevels, labels=ESTIAPlabels)
...
write.csv(NISPUF18, file = paste(PUF, 'NISPUF18.csv', sep = '/'))
write.csv(NISPUF18.CONTENTS, file = paste(PUF, 'NISPUF18_contents.csv', sep = '/'))